...
$conf['settings']['script.url'] = 'http://localhost/emcscheduler/Web/';
...
$conf['settings']['database']['user'] = constant("dbuser");
$conf['settings']['database']['password'] = constant("dbpass");
$conf['settings']['database']['hostspec'] = constant("dbhost");
$conf['settings']['database']['name'] = constant("dbase");
