...
class GenerateReportPresenter extends ActionPresenter
{
	...
	public function ProcessAction()
	{
	    ...
	    if($_POST['submitButton'] == 'submit') {
	        //reset to all
	        $cont = 'User/Owner!s!Resource!s!Test Engineer!s!Project Lead!s!Begin!s!End!s!Duration!s!Hours!s!Title!s!Description!s!Client Name!s!Project No.!s!Request No.!s!Client on Site!s!Sample on Site!s!Schedule!s!Date Created!s!Last Modified!s!Status!s!Reference No.!s!Total!s!Date!s!Utilization!s!Group!s!Billable!s!Type!s!Actual Start!s!Actual End!s!Actual Duration!s!Duration Notes';
	        $obj = new bookingClass;
	        $obj->updateUserColumns($this->user->UserId,$cont,'ReportColumns');
	    }
	...
	private function GetFilter()
	{
		...
		return new Report_Filter($this->page->GetResourceIds(),
                                ...
                                $_POST['projectNo'],
                                $_POST['clientName'],
                                $_POST['project_lead'],$_POST['billable']);
	}
}