...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		$strings['ReferenceNumber'] = 'Reference No.';
		...
		$strings['Users'] = 'Users';
		$strings['OwnerUser'] = 'User/Owner';
		$strings['ClientName'] = 'Client Name';
		$strings['ProjectLead'] = 'Project Lead';
		$strings['Engineer'] = 'Test Engineer';
		$strings['ProjOrderNo'] = 'Order No. / Project No.';
		$strings['RequestNo'] = 'Request No.';
		$strings['ClientOnsite'] = 'Client on Site';
		$strings['SampleOnSite'] = 'Sample on Site';
		$strings['Billable'] = 'Billable';
		$strings['Durationotes'] = 'Duration Notes';
		$strings['Type'] = 'Type';
		$strings['Actual_start'] = 'Actual Start';
		$strings['Actual_end'] = 'Actual End';
		$strings['Total_duration'] = 'Actual Duration';
		...
		$strings['User'] = 'User';
		$strings['User/Owner'] = 'User/Owner';
		$strings['Resource'] = 'Resource';
		$strings['ResourcePrHr'] = 'Resource (PR/HR)';
		...
		$strings['AddHoliday'] = 'Add Holiday';
		$strings['HolidayCreated'] = 'Holiday Created';
		$strings['HolidaySetting'] = 'UL - EMC Scheduler Holiday Setting';
		...
		$strings['ManageHolidaySetting'] = 'Holiday Setting';
		...
		$strings['ParticipantDeletedSubjectWithResource'] = 'Your reservation has been removed';
