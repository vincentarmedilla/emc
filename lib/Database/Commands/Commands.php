...
class AddReservationSeriesCommand extends SqlCommand
{
    ...
    )
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::BILL, $billable));
    }
}
...
class UpdateReservationCommand extends SqlCommand
{
                                ...
                                $timeDuration)
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::CREDIT_COUNT, $credits));
        $this->AddParameter(new Parameter(ParameterNames::DATE_TIME_DURATION, $timeDuration));
    }
}
...
class UpdateReservationSeriesCommand extends SqlCommand
{
    ...
    )
    {
        ...
        $this->AddParameter(new Parameter(ParameterNames::RN, $rn));
        $this->AddParameter(new Parameter(ParameterNames::STATUS, $status));
        $this->AddParameter(new Parameter(ParameterNames::ACTUALSTART, $actualstart));
        $this->AddParameter(new Parameter(ParameterNames::ACTUALEND, $actualend));
        $this->AddParameter(new Parameter(ParameterNames::NOTES, $notes));
        $this->AddParameter(new Parameter(ParameterNames::BILL, $billable));
        $this->AddParameter(new Parameter(ParameterNames::TOTALDURATION, $totalDuration));
