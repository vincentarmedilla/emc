...
class ColumnNames
{
	...
	const USERID = 'userid';
	const CLIENT_ON_SITE = 'client_on_site';
	const SAMPLE_ON_SITE = 'sample_on_site';
	const BILLABLE = 'billable';
	const DURATIONOTES = 'duration_notes';
	const TOTALDURATION = 'total_ducation';
	const STATUS = 'status';
	const ACTUAL_START = 'actualstart';
	const ACTUAL_END = 'actualend';
	const PROJLEADID = 'reservation_instance_id';
	
	const BEGIN_HOLIDAY = 'begin';
	const END_HOLIDAY = 'end';
	const REASON_HOLIDAY = 'reason';
	const SCHEDULE_HOLIDAY = 'schedule';
