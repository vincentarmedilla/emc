...
class Report_Filter
{
	 ...
	 */
	public function __construct($resourceIds, $scheduleIds, $userId, $groupIds, $accessoryIds, $participantId, $includeDeleted, $resourceTypeIds, $projectNo, $clientName, $projectLead, $billable)
	{
...
//             }
            ...
            $schedId = array();
            foreach($schedule_result as $item) {
                $schedId[] = $item['schedule_id'];
            }
	...
	public function Add(ReportCommandBuilder $builder)
	{
        ...
        {
            $builder->WithBillable($this->billable);
        }
