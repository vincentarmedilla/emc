...
class ReportDefinition implements IReportDefinition
{
    ...
    public function __construct(IReport $report, $timezone)
    {
        ...
        $orderedColumns = array(
            ColumnNames::OWNER_FULL_NAME_ALIAS => new ReportStringColumn('User/Owner', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ...
            ColumnNames::INVITEE_LIST => new ReportStringColumn('Engineer', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::PARTICIPANT_LIST => new ReportStringColumn('ProjectLead', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ...
            ColumnNames::CLIENT => new ReportStringColumn('ClientName', ChartColumnDefinition::Null()),
            ColumnNames::PROJECT_NUMBER => new ReportStringColumn('ProjOrderNo', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::REQUEST_NUMBER => new ReportStringColumn('RequestNo', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::CLIENT_ON_SITE => new ReportStringColumn('ClientOnsite', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::SAMPLE_ON_SITE => new ReportStringColumn('SampleOnSite', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::BILLABLE => new ReportStringColumn('Billable', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::DURATIONOTES => new ReportStringColumn('Durationotes', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::STATUS => new ReportStringColumn('Type', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::ACTUAL_START => new ReportStringColumn('Actual_start', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::ACTUAL_END => new ReportStringColumn('Actual_end', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
            ColumnNames::TOTALDURATION => new ReportStringColumn('Total_duration', ChartColumnDefinition::Label(ColumnNames::OWNER_USER_ID)),
