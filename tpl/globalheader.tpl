...
<body {if $HideNavBar == true}style="padding-top:0;"{/if} style="float:left;">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                            <ul class="nav navbar-nav emc-menu">
                                <li><a href="{$Path}{Pages::DASHBOARD}"><img src="img/emc_dashboard_white.png"  width="18">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <div class="collapse" id="application">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item">
                                                        <a href="{$Path}admin/manage_holiday_setting.php">{translate key="ManageHolidaySetting"}</a>
                                                    </li>
                                                <li class="list-group-item">
