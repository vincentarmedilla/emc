<?php
/* Smarty version 3.1.30, created on 2020-10-04 05:10:32
  from "C:\xampp6\htdocs\emcscheduler\tpl\Search\search-reservations.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5f793d28272f36_44304520',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3005f08d834ad128e3aea1858adcc5469ce027a3' => 
    array (
      0 => 'C:\\xampp6\\htdocs\\emcscheduler\\tpl\\Search\\search-reservations.tpl',
      1 => 1599181360,
      2 => 'file',
    ),
  ),
...
function content_5f793d28272f36_44304520 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
?>
        ...
        <div class="form-group col-sm-4">
           ...
           <select id="userFilter2" name="userFilter2" class="form-control">
                <option selected>Project Lead</option>
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['group_users']->value, 'i', false, 'myId');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['myId']->value => $_smarty_tpl->tpl_vars['i']->value) {
...
<!--             <span class="searchclear glyphicon glyphicon-remove-circle" ref="request_no"></span> -->
        ...
        <div class="form-group col-sm-2">
            <label style="font-size:13px"><input type="checkbox" name="client_on_sites" id="client_on_sites" value="Yes">Client On Site</label>&nbsp;
            <label style="font-size:13px"><input type="checkbox" name="sample_on_site" id="sample_on_site" value="Yes">Sample On Site</label>&nbsp;
