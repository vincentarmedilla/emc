<?php
/* Smarty version 3.1.30, created on 2020-06-15 16:26:46
  from "C:\xampp2\htdocs\ulemcscheduler\tpl\Admin\Resources\manage_resources.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ee78526ab8879_33039889',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '61c567cf921451cb311aaa1bf5d1b6e4c3f8ca12' => 
    array (
      0 => 'C:\\xampp2\\htdocs\\ulemcscheduler\\tpl\\Admin\\Resources\\manage_resources.tpl',
      1 => 1590976969,
      2 => 'file',
    ),
  ),
...
function content_5ee78526ab8879_33039889 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_function_html_options')) require_once 'C:\\xampp2\\htdocs\\ulemcscheduler\\lib\\external\\Smarty\\plugins\\function.html_options.php';
?>
...
>
                                            ...
                                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['resourceTyped']->value, 'i', false, 'myId', 'foo', array (
  'iteration' => true,
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['myId']->value => $_smarty_tpl->tpl_vars['i']->value) {
...
">
							...
							<div style="float: left"><div id="" style="float: right"></div>
								Human Resource:<a href="#"></a><div id="hr<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
" style="float: right"></div>
								<select class="form-control" id="human_resources_list" name="human_resources_list">
									<option> Select User</option>
									<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['users_engineer']->value, 'ue');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['ue']->value) {
?>
										<option value="<?php echo $_smarty_tpl->tpl_vars['ue']->value['user_id'];?>
 => <?php echo $_smarty_tpl->tpl_vars['id']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['ue']->value['fname'];?>
 <?php echo $_smarty_tpl->tpl_vars['ue']->value['lname'];?>
</option>
									<?php
}
}
...
?>
						...
						<div class="col-sm-6 col-xs-12">
							...
							<a href="#" data-id="<?php echo $_smarty_tpl->tpl_vars['resource']->value->GetResourceId();?>
" class="update changeUserPermission"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Users'),$_smarty_tpl);?>
</a> |
							<a href="#" data-id="<?php echo $_smarty_tpl->tpl_vars['resource']->value->GetResourceId();?>
" class="update changeGroupPermissions"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Groups'),$_smarty_tpl);?>
</a>
...
?>
						...
						<div class="form-group" id="human_users">
							...
							<select class="form-control selectpicker" id="user_engineer" name="user_engineer" data-live-search="true">
								<option> Select User</option>
								<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['all_users']->value, 'ue');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['ue']->value) {
?>
									<option value="<?php echo $_smarty_tpl->tpl_vars['ue']->value['user_id'];?>
...
?>
							...
							<?php } else { ?>
								<select class="form-control selectpicker" id="user_engineer" name="user_engineer" data-live-search="true">
									<option> Select User</option>
									<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['all_users']->value, 'ue', false, 'myId', 'foo', array (
  'iteration' => true,
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['myId']->value => $_smarty_tpl->tpl_vars['ue']->value) {
$_smarty_tpl->tpl_vars['__smarty_foreach_foo']->value['iteration']++;
?>
									<option value="<?php echo $_smarty_tpl->tpl_vars['ue']->value['user_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['ue']->value['fname'];?>
...
?>
 ...
 id="permissions">
								...
								<option value="0" selected><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>"ResourcePermissionNotAutoGranted"),$_smarty_tpl);?>
</option>
							</select>
						</div>
						<div class="form-group">
							...
							<select class="form-control" <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formname'][0][0]->GetFormName(array('key'=>'RESOURCE_ADMIN_GROUP_ID'),$_smarty_tpl);?>
								...
								<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['resourceAdmin']->value, 'i', false, 'myId');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['myId']->value => $_smarty_tpl->tpl_vars['i']->value) {
?>
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Available'),$_smarty_tpl);?>
							...
							<option value="0"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Hidden'),$_smarty_tpl);?>
</option>
						</select>
					</label>
				</div>
...
?>
					{
						value:<?php echo $_smarty_tpl->tpl_vars['scheduleName']->value['schedule_id'];?>
, text: '<?php echo $_smarty_tpl->tpl_vars['scheduleName']->value['name'];?>
'
					},
					<?php
}
...
',
 ...
 --'
					...
					<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['resourceType']->value, 'resourceTypes', false, 'id');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['id']->value => $_smarty_tpl->tpl_vars['resourceTypes']->value) {
?>
					{
                                            <?php if ($_smarty_tpl->tpl_vars['resourceTypes']->value['resource_type_name'] == '') {?>
    
                                           <?php } else { ?>
                                               value:<?php echo $_smarty_tpl->tpl_vars['resourceTypes']->value['resource_type_id'];?>
, text: '<?php echo strtr($_smarty_tpl->tpl_vars['resourceTypes']->value['resource_type_name'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
'
                                           <?php }?>
					},
					<?php
