<?php
/* Smarty version 3.1.30, created on 2020-10-04 05:10:38
  from "C:\xampp6\htdocs\emcscheduler\tpl\Search\search-reservations-results.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5f793d2e509bb9_74908219',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2bbb96ac9f7021cbf3dcac7d8fff370cc94020b0' => 
    array (
      0 => 'C:\\xampp6\\htdocs\\emcscheduler\\tpl\\Search\\search-reservations-results.tpl',
      1 => 1601705206,
      2 => 'file',
    ),
  ),
...
function content_5f793d2e509bb9_74908219 (Smarty_Internal_Template $_smarty_tpl) {
...
</label></div><div><label><input type="checkbox" checked="checked" name="col14">Billed</label></div></div></div>
...
<div id="report-actions">
	...
	<button type="button" class="btn btn-success" <?php if ($_smarty_tpl->tpl_vars['permission']->value == '0' && $_smarty_tpl->tpl_vars['check']->value == 'user' || $_smarty_tpl->tpl_vars['userView']->value != '0') {?> disabled <?php }?> id="Move_reservation">Move Reservation</button>
...
<table class="table" id="reservationTable">
	...
	<tr>
		...
		<th class="col2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'ResourcePrHr'),$_smarty_tpl);?>
</th>
...
?>
			...
			<td class="description"><?php if ($_smarty_tpl->tpl_vars['reservation']->value->billable == '1') {?>Yes<?php } else { ?>No<?php }?></td>
			<td class="action no-edit">
			<input type="checkbox"  <?php if ($_smarty_tpl->tpl_vars['permission']->value == '0' && $_smarty_tpl->tpl_vars['check']->value == 'user' || $_smarty_tpl->tpl_vars['userView']->value != '0') {?>  disabled <?php }?> value="<?php echo $_smarty_tpl->tpl_vars['reservation']->value->SeriesId;?>
" name="reservations[]"><input type="hidden" name="timezone" id="timezone" value="<?php echo $_smarty_tpl->tpl_vars['Timezone']->value;?>
"></td>
		</tr>
