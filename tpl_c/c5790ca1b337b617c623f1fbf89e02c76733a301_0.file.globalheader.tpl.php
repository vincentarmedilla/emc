<?php
/* Smarty version 3.1.30, created on 2020-10-04 06:04:38
  from "C:\xampp6\htdocs\emcscheduler\tpl\globalheader.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5f7949d6a8e4f7_47979564',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c5790ca1b337b617c623f1fbf89e02c76733a301' => 
    array (
      0 => 'C:\\xampp6\\htdocs\\emcscheduler\\tpl\\globalheader.tpl',
      1 => 1596363018,
      2 => 'file',
    ),
  ),
...
function content_5f7949d6a8e4f7_47979564 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
...
<body <?php if ($_smarty_tpl->tpl_vars['HideNavBar']->value == true) {?>style="padding-top:0;"<?php }?> style="float:left;">
...
<div id="main" class="container-fluid" style="float: left;">
    <?php echo '<script'; ?>
...
"><img src="img/emc_dashboard_white.png"  width="18">
                                ...
                                <li class="dropdown">
                                    ...
                                    <img src="img/emc_calendar_white.png"  width="18">
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>"SearchReservations"),$_smarty_tpl);?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['CanViewAdmin']->value) {?>
                                    <li class="dropdown">
                                        ...
                                        <img src="img/emc_setting_white.png"  width="18">
...
admin/manage_blackouts.php"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>"ManageBlackouts"),$_smarty_tpl);?>
                                                ...
                                                <li class="list-group-item">
                                                        <a href="<?php echo $_smarty_tpl->tpl_vars['Path']->value;?>
admin/manage_holiday_setting.php"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>"ManageHolidaySetting"),$_smarty_tpl);?>
</a>
                                                    </li>
                                                <li class="list-group-item">
                                                    <a href="<?php echo $_smarty_tpl->tpl_vars['Path']->value;?>
...
admin/manage_announcements.php"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>"ManageAnnouncements"),$_smarty_tpl);?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['CanViewReports']->value) {?>
                                    <li class="dropdown">
                                        ...
                                        <img src="img/emc_reports_white.png"  width="18">
...
<!--                                                 </li> -->
                                ...
                                <li class="dropdown">
                                    ...
                                    <img src="img/emc_user_white.png"  width="18"><span class="texthide">Profile</span></a>
