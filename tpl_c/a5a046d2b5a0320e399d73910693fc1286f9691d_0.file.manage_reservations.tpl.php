<?php
/* Smarty version 3.1.30, created on 2020-06-13 17:21:16
  from "C:\xampp2\htdocs\ulemcscheduler\tpl\Admin\Reservations\manage_reservations.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ee4eeec0544f4_63973593',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a5a046d2b5a0320e399d73910693fc1286f9691d' => 
    array (
      0 => 'C:\\xampp2\\htdocs\\ulemcscheduler\\tpl\\Admin\\Reservations\\manage_reservations.tpl',
      1 => 1590421445,
      2 => 'file',
    ),
  ),
...
function content_5ee4eeec0544f4_63973593 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_function_cycle')) require_once 'C:\\xampp2\\htdocs\\ulemcscheduler\\lib\\external\\Smarty\\plugins\\function.cycle.php';
if (!is_callable('smarty_modifier_truncate')) require_once 'C:\\xampp2\\htdocs\\ulemcscheduler\\lib\\external\\Smarty\\plugins\\modifier.truncate.php';
?>
...
">
					...
					<select id="scheduleId" name="scheduleId" class="form-control selectpicker" data-live-search="true">
...
">
					...
					<select id="resourceId" name="resourceId" class="form-control selectpicker" data-live-search="true">
						<option value="">All Resources</option>
						<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['resources']->value, 'i', false, 'myId');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['myId']->value => $_smarty_tpl->tpl_vars['i']->value) {
?>
							<option label="<?php echo $_smarty_tpl->tpl_vars['i']->value['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['i']->value['resource_id'];?>
">
								<?php echo $_smarty_tpl->tpl_vars['i']->value['name'];?>
...
"/>
					<input id="referenceNumber" type="hidden" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ReservationDescription']->value;?>
"
						   placeholder="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Description'),$_smarty_tpl);?>
"/>
...
">
				...
				<td class="reservationTitle"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['reservation']->value->Title,30,"...",true);?>
</td>
				<td class="description"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['reservation']->value->Description,30,"...",true);?>
</td>
