<?php
/* Smarty version 3.1.30, created on 2020-10-05 00:28:22
  from "C:\xampp6\htdocs\emcscheduler\tpl\Ajax\respopup.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5f7a4c86f3a8b6_76046473',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '71146fec6564a93af75533d34e9d1cb7752a2347' => 
    array (
      0 => 'C:\\xampp6\\htdocs\\emcscheduler\\tpl\\Ajax\\respopup.tpl',
      1 => 1599184965,
      2 => 'file',
    ),
  ),
...
function content_5f7a4c86f3a8b6_76046473 (Smarty_Internal_Template $_smarty_tpl) {
...
<!--    <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formatdate'][0][0]->FormatDate(array('date'=>$_smarty_tpl->tpl_vars['startDate']->value,'key'=>'res_popup'),$_smarty_tpl);?>
 ...
 <br>
    ...
    <strong>Title:</strong> <?php if ($_smarty_tpl->tpl_vars['title']->value != '') {?><div style="width:300px;"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</div><!--<?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['title']->value,30,"...",true);?>
--><?php } else {
echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'NoTitleLabel'),$_smarty_tpl);
    ...
    <strong>Description:</strong> <?php if ($_smarty_tpl->tpl_vars['summary']->value != '') {?><div style="width:300px;"><?php echo $_smarty_tpl->tpl_vars['summary']->value;?>
</div><!--  <?php echo nl2br(smarty_modifier_truncate($_smarty_tpl->tpl_vars['summary']->value,30,"..."));?>
--><?php } else {
...
<br>
    ...
    <strong>Client on site:</strong> <?php echo $_smarty_tpl->tpl_vars['cos']->value;?>
<br>
    <?php }?>
    
     <?php if (in_array('sampleonsite',$_smarty_tpl->tpl_vars['userFields']->value)) {?>
    <strong>Sample on site:</strong> <?php echo $_smarty_tpl->tpl_vars['sos']->value;?>
<br>
    <?php }?>
	
	<?php if (in_array('billable',$_smarty_tpl->tpl_vars['userFields']->value)) {?>
    <strong>Billable:</strong> <?php if ($_smarty_tpl->tpl_vars['billable']->value == '1') {?> Yes <?php } else { ?> No <?php }?>
    <?php }?>
